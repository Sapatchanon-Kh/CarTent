...
const PickupCarPage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        // Add an event listener to reload data when the window gets focus
        // This ensures data is fresh when navigating back to this page
    ...
    return (
        <Layout>
            ...
            <Content style={{ padding: '0 48px', background: '#262626' }}>
                <Breadcrumb style={{ margin: '16px 0' }} items={[{ title: <Text style={{ color: '#999' }}>Home</Text> }, { title: <Text style={{ color: 'white' }}>Pickup History</Text> }]} />
