...
import { MenuOutlined, PlusCircleOutlined, EditOutlined, CalendarOutlined, ClockCircleOutlined, UserOutlined, CloseCircleOutlined } from '@ant-design/icons';
      ...
      <Content style={{ padding: '0 48px' }}>
        ...
        >
          <Row align="middle" justify="space-between" style={{ marginBottom: '16px' }}>
            <Col>
              <h1 style={{ color: 'white', fontSize: '2em', fontWeight: 'normal' }}>ประวัติการนัดตรวจสภาพรถยนต์</h1>
            </Col>
            <Col>
              <Button
                type="primary"
                  ...
                  <Row gutter={[16, 16]} style={{ marginTop: '20px' }}>
                    ...
                    <Col span={24}>
                      <div style={{ display: 'flex', alignItems: 'center', marginBottom: '10px' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column' }}>
                          <span style={{ color: '#aaaaaa' }}>ระบบที่ต้องการตรวจสอบ</span>
                          <span style={{ color: 'white', fontWeight: 'bold' }}>{booking.system}</span>
                        </div>
                      </div>
                    </Col>
