...
import IndexPage from './pages/inspection/InspectionCarPage.tsx'; 
import LoginPage from './pages/login/LoginPage.tsx';
import BuyCarPage from './pages/buycar/BuyCar.tsx'; 
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/inspection-car" element={<IndexPage />} /> {/* ใช้ IndexPage เนื่องจากเป็นหน้านัดหมายอยู่แล้ว */}
